...
<body>
    ...
    <div class="backy pb-5">
            ...
            <div class="text-white text-center px-4">
                <div class="row">
                    <div class="column ml-5">
                        <h1 class="card-title display-3 pt-3 mb-5 font-bold">
                            <strong>Windows Subsystem for Linux 2</strong></h1>
                        <h2 class="card-title h1-responsive pt-3 mb-5 font-bold">
                            <strong>No XAMPP <i class="fab fa-windows teal-text"></i>&emsp; No Docker
                                <i class="fab fa-docker blue-text"></i></strong></h2>
                    </div>
        ...
        <div class="container cloudy-knoxville-gradient text-black-50 z-depth-1-half p-5">
